...
class EBAttendees{
  ...
  public function loadAttendeesFromResource(array $params){
    ...
    foreach($response->attendees as $attendee){
      ...
      $create_date = SBOCDBMgr::convert_from_date_tz($create_date, EBConsts::tz_UTC, EBConsts::tz_Site_Default);
      $change_date = SBOCDBMgr::convert_from_date_tz($change_date,  EBConsts::tz_UTC, EBConsts::tz_Site_Default);
